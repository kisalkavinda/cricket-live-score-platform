      ...
      <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: 800, color: '#F1F5F9', margin: '0 0 6px 0', display: 'flex', alignItems: 'center', gap: '10px' }}>
            <span>🌿</span> CPL 8-Team Tournament Bracket & Groups
          </h1>
          <p style={{ fontSize: '13px', color: '#94A3B8', margin: 0 }}>
            Configure tournament format settings, assign groups, generate 15-match fixtures, and recalculate ball-based NRR.
          </p>
        </div>
      </div>
