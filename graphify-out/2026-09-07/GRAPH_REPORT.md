...
## Corpus Check
- 171 files · ~192,983 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1147 nodes · 2262 edges · 78 communities (61 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff060fd5`
...
Cohesion: 0.07
Nodes (61): RegisterPage(), GroupDrawAdminConsole(), Props, AdminTournamentDrawPage(), dynamic, DrawCeremonyClient(), Props, dynamic (+53 more)
...
Cohesion: 0.21
Nodes (17): Props, ScoringConsole(), handleSaveEditedBall(), handleStartSuperOver(), requireAdminAuth(), changeBowlerAction(), completeMatchAction(), editBallDeliveryAction() (+9 more)

### Community 37 - "getAdminEntryPath"
Cohesion: 0.07
Nodes (49): dynamic, fetchFreshStats(), GET(), robots(), dynamic, NewMatchPage(), AdminTournamentBracketPage(), dynamic (+41 more)

### Community 38 - "admin-service.ts"
Cohesion: 0.33
Nodes (9): AdminRegistrationDetailPage(), approveRegistrationTransaction(), DashboardStats, getRegistrationDetail(), matchesIntakeOrIndex(), matchesRegistrationException(), RegistrationsQuery, retryBackupService() (+1 more)

### Community 39 - "teams/[id]/page.tsx"
Cohesion: 0.26
Nodes (10): dynamic, TeamDetailPage(), RemovePlayerFromTeamButton(), handleRemove(), RemovePlayerProps, addPlayerToTeamServerAction(), createAndAssignPlayerServerAction(), removePlayerFromTeamServerAction() (+2 more)
...
Cohesion: 0.30
Nodes (13): applyOperationToProjection(), computeLocalProjection(), BOWLER_CREDITED_WICKETS, calculateBowlerMaidens(), calculateBowlerRunsFromDelivery(), calculateDeliveryRuns(), calculateMaidensMap(), DeliveryRunsResult (+5 more)
...
### Community 46 - "RegistrationDetailClient.tsx"
Cohesion: 0.24
...
Cohesion: 0.15
Nodes (20): changeBowler(), completeMatch(), getMatchDetail(), notifyMatchUpdated(), startMatch(), startSuperOver(), swapStriker(), switchBatter() (+12 more)

### Community 52 - "DeleteTeamButton.tsx"
Cohesion: 0.50
...
### Community 62 - "createTournamentServerAction"
Cohesion: 0.67
Nodes (3): NewTournamentPage(), handleSubmit(), createTournamentServerAction()

### Community 63 - "scoring-actions.ts"
Cohesion: 0.15
Nodes (19): NewMatchForm(), Props, Team, Tournament, createMatchAction(), startMatchAction(), createMatch(), changeBowlerSchema (+11 more)

### Community 64 - "scoring-service.ts"
Cohesion: 0.13
Nodes (25): dynamic, fetchFreshLiveMatches(), GET(), handleDeleteBall(), handleUpdateBallsPerOver(), deleteBallDeliveryAction(), updateMatchRulesAction(), broadcastScoreUpdate() (+17 more)
...
## Knowledge Gaps
- **483 isolated node(s):** `dynamic`, `dynamic`, `Tournament`, `Team`, `Props` (+478 more)
...
- **Why does `requireAdminAuth()` connect `requireAdminAuth` to `index.ts`, `scoring-service.ts`, `app/page.tsx`, `admin-actions.ts`, `players/[id]/page.tsx`, `getAdminEntryPath`, `createPerfTracker`, `admin-service.ts`, `teams/[id]/page.tsx`, `recordDelivery`, `RegistrationDetailClient.tsx`, `offline-resilient-scoring.test.ts`, `DeleteTeamButton.tsx`, `registration-exceptions/page.tsx`, `admin-auth.ts`, `createTournamentServerAction`, `scoring-actions.ts`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `prisma` connect `index.ts` to `scoring-service.ts`, `scorecard/route.ts`, `admin-actions.ts`, `players/[id]/page.tsx`, `getAdminEntryPath`, `createPerfTracker`, `teams/[id]/page.tsx`, `admin-service.ts`, `RegistrationForm.tsx`, `test-concurrency-deep-gate.ts`, `offline-resilient-scoring.test.ts`, `registration-exceptions/page.tsx`?**
